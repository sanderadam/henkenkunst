"""
Django settings for henkenkunst project.
...
ALLOWED_HOSTS = ['sanderadam.pythonanywhere.com', '127.0.0.1']
...
WSGI_APPLICATION = 'henkenkunst.wsgi.application'
